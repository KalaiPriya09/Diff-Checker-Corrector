...
export const InputActions: React.FC<InputActionsProps> = ({
  ...
  return (
    <ActionButtonsContainer>
      <ActionButton onClick={handleUploadClick} title="Upload File">
      ...
      <ActionButton onClick={handlePrettier} title="Format Code">
      ...
      <ActionButton onClick={handleDownload} title="Download as File">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
