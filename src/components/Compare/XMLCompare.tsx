...
export const XMLCompare: React.FC = () => {
  const defaultOptions = getDefaultComparisonOptions('xml-compare');
    ...
    <>
      ...
      {hasCompared && result && (
        <ComparisonResults
          ...
          successMessage="No Differences Found - The XML documents are identical."
        />
      )}
    </>
  );
